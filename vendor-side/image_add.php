...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Rattle n Roll | Image Add</title>
						...
						<div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Add Image</h4>
						...
						<div class="row">
                            <div class="col-lg-12">
                                <div class="card">
									...
									<form method="post" enctype="multipart/form-data"  action="insert_item_image.php">
                                        <h4 class="card-title">Select Product Name : </h4>
                                        
        
                                        
                                            
												<select class="btn btn-secondary" name="pname" id="pname" >
													
													  <option>---Select Product---</option>
													   <?php
														$s = $link->rawQuery("select * from producttb where vendor_id=$sessionid");

														foreach($s as $s1)
														{
															?>
															<option value="<?php echo $s1["product_id"]; ?>">
