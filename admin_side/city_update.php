...
<head>
<title>Rattle n Roll | City-Edit</title>
<meta charset="utf-8">
...
<h4 class="font-weight-bold py-3 mb-0">City Edit</h4>
<div class="text-muted small mt-0 mb-4 d-block breadcrumb">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
<li class="breadcrumb-item active"><a href="city_update.php">City Edit</a></li>
</ol>
</div>
...
<?php
$city_id = $_GET['cityid'];
$s = $link->rawQuery("select * from citytb where city_id=?",array($city_id));
if($link->count >0)
{
	foreach($s as $s1)
	{
	$state_id=$s1['state_id'];
	$city_name=$s1['city_name'];
	}
}
?>
...
<?php
	$c = $link->rawQuery("select * from statetb");
	foreach ($c as $c1) {
		?>
			<option value="<?php echo $c1["state_id"]; ?>" <?php 
			if($c1["state_id"]==$state_id)
				{
					echo 'selected';
				} 
				?> >
				<?php echo $c1["state_name"]; ?>
			</option>
		<?php
	}
?>
...
<div class="select2-primary">
	...
	<input type="text" class="form-control" id="city_name" name="city_name" value="<?php echo $city_name; ?>">		
...
if(isset($_POST['btnadd']))
{
	...
	$qry = $link->update("citytb",array("city_name"=>$city , "state_id"=>$state));
