...
<head>
<title>Rattle n Roll | Category-Add</title>
<meta charset="utf-8">
...
<h4 class="font-weight-bold py-3 mb-0">Category Add</h4>
<div class="text-muted small mt-0 mb-4 d-block breadcrumb">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
<li class="breadcrumb-item active"><a href="product_category_add.php">category Add</a></li>
</ol>
</div>
...
<div class="card mb-4">
<h6 class="card-header">Enter Category Name : </h6>
<div class="card-body">
...
if(isset($_POST['btnadd']))
{
	...
	$qry = $link->insert("product_categorytb",array("category_name"=>$category));
