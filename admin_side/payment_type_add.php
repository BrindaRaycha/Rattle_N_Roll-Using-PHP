...
<head>
<title>Rattle n Roll | Payment-Type-Add</title>
<meta charset="utf-8">
...
<h4 class="font-weight-bold py-3 mb-0">Payment Type Add</h4>
<div class="text-muted small mt-0 mb-4 d-block breadcrumb">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
<li class="breadcrumb-item active"><a href="payment_type_add.php">Payment Type Add</a></li>
</ol>
</div>
...
<div class="card mb-4">
<h6 class="card-header">Enter Payment Type : </h6>
<div class="card-body">
<div class="form-group">

<input type="text" class="form-control" name="txtpayment" id="txtpayment">
...
if(isset($_POST['btnadd']))
{
	...
	$qry = $link->insert("payment_typetb",array("payment_type"=>$payment));
