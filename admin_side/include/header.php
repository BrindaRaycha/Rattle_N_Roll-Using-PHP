...
if($link->count > 0)
{
	...
	{
		?>
	<img src="<?php echo $q["admin_photo"]; ?>" alt class="d-block ui-w-40 rounded-circle">
<span class="px-1 mr-lg-2 ml-2 ml-lg-0">
<?php
	echo $_SESSION['adminsessionname'];	
	}
...
<a href="admin_password_reset.php" class="dropdown-item">
<i class="feather icon-user text-muted"></i> &nbsp; Change Password</a>
<div class="dropdown-divider"></div>
